...
public class ThanThu {
    ...
    public void hatchedEgg() {
        ...
        addOption(new ItemOption(ST_NGUOI_ID, 100));
    }
    ...
    public void levelUp() {
        ...
        if (this.level <= 100) {
            ...
            for (ItemOption o : options) {
                ...
                if(o.optionTemplate.id == ST_NGUOI_ID){
                    // levelPer10 là số chia hết cho 10 => 100 lv là 10 lần => 1s * 300 * 10 = 3000
                    int add = stars * 5 * levelPer10;
                    o.param += add;
                }else{
